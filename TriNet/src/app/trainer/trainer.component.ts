...
export class TrainerComponent implements OnInit{
    ...
    getPrediction() {
        ...
        var outputJson = {
            ...
            resultado: this.letra,
        }
        this.http.post<{data: string, dimension: number, resultado: string}>("http://localhost:3000/api/trainer", outputJson)
        .subscribe(response => {
            this.prediction = response.resultado
        });
    }
    reset() {
        this.myp5.reset()
